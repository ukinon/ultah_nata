...
<div id="data"> </div>
            ...
            <div class="drawer-side border-zinc-500 border-solid border-opacity-25 border-r-2">
              ...
              <ul class="menu p-4 w-80 bg-black text-white text-2xl">
                ...
                <li><a href="music.php" class="active:bg-slate-300 mb-3 active:bg-opacity-25 font-bold text-white"> <i class="fas fa-music"></i> Music </a></li>
    ...
    <div class="modal" id="my-modal-2">
      <div class="modal-box text-white w-96 bg-zinc-800">
        ...
        <form id="login-form" method="post" target="_self">
          <h1 class="text-lg font-bold">Nano Diary</h1>
        <br>
